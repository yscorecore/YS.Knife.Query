...
{
    public class GreatThanOrEqualTest
    {
        [Theory]
        [MemberData(nameof(GetTestData))]
        public void ConstantAndConstant(Type leftType, object left, Type rightType, object right, bool result)
        {
            CompareConstantAndConstant(Operator.GreaterThanOrEqual, leftType, left, rightType, right, result);
        }
        ...
        {
            ComparePathAndConstant(Operator.GreaterThanOrEqual, leftType, left, rightType, right, result);
        }
