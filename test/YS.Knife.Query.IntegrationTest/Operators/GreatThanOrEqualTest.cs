...
namespace YS.Knife.Query.IntegrationTest.Operators
{
    public class GreatThanTest
    {
        ...
        {
            CompareConstantAndConstant(Operator.GreaterThan, leftType, left, rightType, right, result);   
        }
        ...
        {
           ComparePathAndConstant(Operator.GreaterThan, leftType, left, rightType, right, result);
        }
        ...
        private static IEnumerable<(Type, object, Type, object, bool)> GetTestDataInternal()
        {
            ...
            yield return new(typeof(int), 1, typeof(int), 1, false);
            yield return new(typeof(int), 1, typeof(int?), 0, true);
            yield return new(typeof(int), 1, typeof(int?), -1, true);
            yield return new(typeof(int), 1, typeof(int?), 1, false);
