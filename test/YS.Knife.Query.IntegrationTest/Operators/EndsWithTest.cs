...
namespace YS.Knife.Query.IntegrationTest.Operators
{
    public class NotEndsWithTest
    {
        ...
        {
            CompareConstantAndConstant(Operator.NotEndsWith, leftType, left, rightType, right, result);   
        }
        ...
        {
           ComparePathAndConstant(Operator.NotEndsWith, leftType, left, rightType, right, result);
        }
        ...
        private static IEnumerable<(Type, object, Type, object, bool)> GetTestDataInternal()
        {
            ...
            yield return new(typeof(int), 123, typeof(int), 23, false);
