...
namespace YS.Knife.Query.IntegrationTest.Operators
{
    public class LessThanTest
    {
        ...
        {
            CompareConstantAndConstant(Operator.LessThan, leftType, left, rightType, right, result);
        }
        ...
        {
            ComparePathAndConstant(Operator.LessThan, leftType, left, rightType, right, result);
        }
