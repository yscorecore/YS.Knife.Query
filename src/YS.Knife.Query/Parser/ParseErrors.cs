...
namespace YS.Knife.Query.Parser
{
    class ParseErrors
    {
        ...
        {
            throw new FilterInfoParseException($"Invalid select expression, the function limit missing body");
        }
        public static Exception CollectionOrderByFunctionMissingBody(ParseContext context)
        {
            throw new FilterInfoParseException($"Invalid select expression, the function orderby missing body");
        }
        public static Exception CollectionWhereFunctionMissingBody(ParseContext context)
        {
            throw new FilterInfoParseException($"Invalid select expression, the function where missing body");
        }
        ...
        {
            throw new FilterInfoParseException($"The number of function parameters exceeds the range");
        }
